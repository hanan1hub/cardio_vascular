...
// ========== CONFIGURATION ==========
// WiFi Credentials
const char* ssid = "SoC_Lab";           // Change this
const char* password = "research@soc";    // Change this
...
const char* SERVER_URL = "http://10.7.161.78:5000";  // Change this to your server IP
